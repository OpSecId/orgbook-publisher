...
class Mappings(BaseModel):
    entityId: str = Field(example='$.credentialSubject.issuedTo.identifier')
    titleType: str = Field(example='$.credentialSubject.assessments[0].titleType')
    titleNumber: str = Field(example='$.credentialSubject.assessments[0].titleNumber')
